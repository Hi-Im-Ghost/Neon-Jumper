...
在以下的 {\ttfamily messagereader} 例子中，{\ttfamily \mbox{\hyperlink{messagereader_8cpp_a5cd118312f7d5b3983499e2934611ebf}{Parse\+Messages()}}} 解析一个 JSON，该 JSON 应该是一个含键值对的 object。
