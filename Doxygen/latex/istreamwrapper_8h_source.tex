...
\DoxyCodeLine{52 }
\DoxyCodeLine{54 }
\DoxyCodeLine{57     \mbox{\hyperlink{class_basic_i_stream_wrapper_a3e9a2dd2b6b28243f8f2a911f67cdf56}{BasicIStreamWrapper}}(StreamType \&stream) : stream\_(stream), buffer\_(peekBuffer\_), bufferSize\_(4), bufferLast\_(0), current\_(buffer\_), readCount\_(0), count\_(0), eof\_(false) \{ }
...
\DoxyCodeLine{70     \}}
\DoxyCodeLine{71 }
\DoxyCodeLine{72     \mbox{\hyperlink{class_basic_i_stream_wrapper_a88e4288ecdaa0d31ddf4e5917b9aa8d7}{Ch}} \mbox{\hyperlink{class_basic_i_stream_wrapper_a0ad1488235b4786dd4f7a16e679dec88}{Peek}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} *current\_; \}}
...
\DoxyCodeLine{74     \textcolor{keywordtype}{size\_t} \mbox{\hyperlink{class_basic_i_stream_wrapper_ac212848265f937add49bd973de794e25}{Tell}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} count\_ + \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(current\_ -\/ buffer\_); \}}
\DoxyCodeLine{75 }
...
\DoxyCodeLine{84         \textcolor{keywordflow}{return} (current\_ + 4 -\/ !eof\_ <= bufferLast\_) ? current\_ : 0;}
\DoxyCodeLine{85     \}}
\DoxyCodeLine{86 }
\DoxyCodeLine{87 \textcolor{keyword}{private}:}
\DoxyCodeLine{88     \mbox{\hyperlink{class_basic_i_stream_wrapper}{BasicIStreamWrapper}}();}
\DoxyCodeLine{89     \mbox{\hyperlink{class_basic_i_stream_wrapper}{BasicIStreamWrapper}}(\textcolor{keyword}{const} \mbox{\hyperlink{class_basic_i_stream_wrapper}{BasicIStreamWrapper}}\&);}
\DoxyCodeLine{90     \mbox{\hyperlink{class_basic_i_stream_wrapper}{BasicIStreamWrapper}}\& operator=(\textcolor{keyword}{const} \mbox{\hyperlink{class_basic_i_stream_wrapper}{BasicIStreamWrapper}}\&);}
\DoxyCodeLine{91 }
\DoxyCodeLine{92     \textcolor{keywordtype}{void} Read() \{}
\DoxyCodeLine{93         \textcolor{keywordflow}{if} (current\_ < bufferLast\_)}
\DoxyCodeLine{94             ++current\_;}
\DoxyCodeLine{95         \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (!eof\_) \{}
\DoxyCodeLine{96             count\_ += readCount\_;}
\DoxyCodeLine{97             readCount\_ = bufferSize\_;}
\DoxyCodeLine{98             bufferLast\_ = buffer\_ + readCount\_ -\/ 1;}
\DoxyCodeLine{99             current\_ = buffer\_;}
\DoxyCodeLine{100 }
\DoxyCodeLine{101             \textcolor{keywordflow}{if} (!stream\_.read(buffer\_, \textcolor{keyword}{static\_cast<}std::streamsize\textcolor{keyword}{>}(bufferSize\_))) \{}
\DoxyCodeLine{102                 readCount\_ = \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(stream\_.gcount());}
\DoxyCodeLine{103                 *(bufferLast\_ = buffer\_ + readCount\_) = \textcolor{charliteral}{'\(\backslash\)0'};}
\DoxyCodeLine{104                 eof\_ = \textcolor{keyword}{true};}
\DoxyCodeLine{105             \}}
\DoxyCodeLine{106         \}}
\DoxyCodeLine{107     \}}
\DoxyCodeLine{108 }
\DoxyCodeLine{109     StreamType \&stream\_;}
\DoxyCodeLine{110     \mbox{\hyperlink{class_basic_i_stream_wrapper_a88e4288ecdaa0d31ddf4e5917b9aa8d7}{Ch}} peekBuffer\_[4], *buffer\_;}
\DoxyCodeLine{111     \textcolor{keywordtype}{size\_t} bufferSize\_;}
\DoxyCodeLine{112     \mbox{\hyperlink{class_basic_i_stream_wrapper_a88e4288ecdaa0d31ddf4e5917b9aa8d7}{Ch}} *bufferLast\_;}
\DoxyCodeLine{113     \mbox{\hyperlink{class_basic_i_stream_wrapper_a88e4288ecdaa0d31ddf4e5917b9aa8d7}{Ch}} *current\_;}
\DoxyCodeLine{114     \textcolor{keywordtype}{size\_t} readCount\_;}
\DoxyCodeLine{115     \textcolor{keywordtype}{size\_t} count\_;  }
\DoxyCodeLine{116     \textcolor{keywordtype}{bool} eof\_;}
\DoxyCodeLine{117 \};}
\DoxyCodeLine{118 }
