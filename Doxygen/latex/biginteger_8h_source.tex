...
\DoxyCodeLine{35 }
\DoxyCodeLine{36     \mbox{\hyperlink{classinternal_1_1_big_integer_abec623168bc9494dec2f50643b897f72}{BigInteger}}(\textcolor{keyword}{const} \mbox{\hyperlink{classinternal_1_1_big_integer}{BigInteger}}\& rhs) : count\_(rhs.count\_) \{}
\DoxyCodeLine{37         std::memcpy(digits\_, rhs.digits\_, count\_ * \textcolor{keyword}{sizeof}(\mbox{\hyperlink{classinternal_1_1_big_integer_a1310812fca26ebae77594ba08678fc4c}{Type}}));}
\DoxyCodeLine{38     \}}
\DoxyCodeLine{39 }
\DoxyCodeLine{40     \textcolor{keyword}{explicit} \mbox{\hyperlink{classinternal_1_1_big_integer_ad02b0ef9da203efddd4af07e923732c0}{BigInteger}}(\mbox{\hyperlink{stdint_8h_aec6fcb673ff035718c238c8c9d544c47}{uint64\_t}} u) : count\_(1) \{}
\DoxyCodeLine{41         digits\_[0] = u;}
\DoxyCodeLine{42     \}}
\DoxyCodeLine{43 }
\DoxyCodeLine{44     \textcolor{keyword}{template}<\textcolor{keyword}{typename} Ch>}
\DoxyCodeLine{45     \mbox{\hyperlink{classinternal_1_1_big_integer_a4dc2632b2aa2973d18864a127d7c141a}{BigInteger}}(\textcolor{keyword}{const} Ch* decimals, \textcolor{keywordtype}{size\_t} length) : count\_(1) \{}
...
\DoxyCodeLine{51             AppendDecimal64(decimals + i, decimals + i + kMaxDigitPerIteration);}
...
\DoxyCodeLine{57             AppendDecimal64(decimals + i, decimals + i + length);}
\DoxyCodeLine{58     \}}
\DoxyCodeLine{59     }
...
\DoxyCodeLine{63             count\_ = rhs.count\_;}
\DoxyCodeLine{64             std::memcpy(digits\_, rhs.digits\_, count\_ * \textcolor{keyword}{sizeof}(\mbox{\hyperlink{classinternal_1_1_big_integer_a1310812fca26ebae77594ba08678fc4c}{Type}}));}
\DoxyCodeLine{65         \}}
...
\DoxyCodeLine{70         digits\_[0] = u;            }
\DoxyCodeLine{71         count\_ = 1;}
...
\DoxyCodeLine{76         \mbox{\hyperlink{classinternal_1_1_big_integer_a1310812fca26ebae77594ba08678fc4c}{Type}} backup = digits\_[0];}
\DoxyCodeLine{77         digits\_[0] += u;}
\DoxyCodeLine{78         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} i = 0; i < count\_ -\/ 1; i++) \{}
\DoxyCodeLine{79             \textcolor{keywordflow}{if} (digits\_[i] >= backup)}
\DoxyCodeLine{80                 \textcolor{keywordflow}{return} *\textcolor{keyword}{this}; \textcolor{comment}{// no carry}}
\DoxyCodeLine{81             backup = digits\_[i + 1];}
\DoxyCodeLine{82             digits\_[i + 1] += 1;}
\DoxyCodeLine{83         \}}
\DoxyCodeLine{84 }
\DoxyCodeLine{85         \textcolor{comment}{// Last carry}}
\DoxyCodeLine{86         \textcolor{keywordflow}{if} (digits\_[count\_ -\/ 1] < backup)}
\DoxyCodeLine{87             PushBack(1);}
\DoxyCodeLine{88 }
...
\DoxyCodeLine{98         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} i = 0; i < count\_; i++) \{}
\DoxyCodeLine{99             \mbox{\hyperlink{stdint_8h_aec6fcb673ff035718c238c8c9d544c47}{uint64\_t}} hi;}
\DoxyCodeLine{100             digits\_[i] = MulAdd64(digits\_[i], u, k, \&hi);}
\DoxyCodeLine{101             k = hi;}
\DoxyCodeLine{102         \}}
\DoxyCodeLine{103         }
\DoxyCodeLine{104         \textcolor{keywordflow}{if} (k > 0)}
\DoxyCodeLine{105             PushBack(k);}
\DoxyCodeLine{106 }
...
\DoxyCodeLine{116         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} i = 0; i < count\_; i++) \{}
\DoxyCodeLine{117             \textcolor{keyword}{const} \mbox{\hyperlink{stdint_8h_aec6fcb673ff035718c238c8c9d544c47}{uint64\_t}} c = digits\_[i] >> 32;}
\DoxyCodeLine{118             \textcolor{keyword}{const} \mbox{\hyperlink{stdint_8h_aec6fcb673ff035718c238c8c9d544c47}{uint64\_t}} d = digits\_[i] \& 0xFFFFFFFF;}
...
\DoxyCodeLine{123             digits\_[i] = (p0 \& 0xFFFFFFFF) | (p1 << 32);}
\DoxyCodeLine{124             k = p1 >> 32;}
\DoxyCodeLine{125         \}}
\DoxyCodeLine{126         }
\DoxyCodeLine{127         \textcolor{keywordflow}{if} (k > 0)}
\DoxyCodeLine{128             PushBack(k);}
\DoxyCodeLine{129 }
...
\DoxyCodeLine{135 }
\DoxyCodeLine{136         \textcolor{keywordtype}{size\_t} offset = shift / kTypeBit;}
\DoxyCodeLine{137         \textcolor{keywordtype}{size\_t} interShift = shift \% kTypeBit;}
\DoxyCodeLine{138         \mbox{\hyperlink{group___r_a_p_i_d_j_s_o_n___c_o_n_f_i_g_gabeba18d612187bad2ac62aed9276d47c}{RAPIDJSON\_ASSERT}}(count\_ + offset <= kCapacity);}
\DoxyCodeLine{139 }
\DoxyCodeLine{140         \textcolor{keywordflow}{if} (interShift == 0) \{}
\DoxyCodeLine{141             std::memmove(digits\_ + offset, digits\_, count\_ * \textcolor{keyword}{sizeof}(\mbox{\hyperlink{classinternal_1_1_big_integer_a1310812fca26ebae77594ba08678fc4c}{Type}}));}
\DoxyCodeLine{142             count\_ += offset;}
\DoxyCodeLine{143         \}}
\DoxyCodeLine{144         \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{145             digits\_[count\_] = 0;}
\DoxyCodeLine{146             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} i = count\_; i > 0; i-\/-\/)}
\DoxyCodeLine{147                 digits\_[i + offset] = (digits\_[i] << interShift) | (digits\_[i -\/ 1] >> (kTypeBit -\/ interShift));}
\DoxyCodeLine{148             digits\_[offset] = digits\_[0] << interShift;}
\DoxyCodeLine{149             count\_ += offset;}
\DoxyCodeLine{150             \textcolor{keywordflow}{if} (digits\_[count\_])}
\DoxyCodeLine{151                 count\_++;}
\DoxyCodeLine{152         \}}
\DoxyCodeLine{153 }
\DoxyCodeLine{154         std::memset(digits\_, 0, offset * \textcolor{keyword}{sizeof}(\mbox{\hyperlink{classinternal_1_1_big_integer_a1310812fca26ebae77594ba08678fc4c}{Type}}));}
\DoxyCodeLine{155 }
...
\DoxyCodeLine{160         \textcolor{keywordflow}{return} count\_ == rhs.count\_ \&\& std::memcmp(digits\_, rhs.digits\_, count\_ * \textcolor{keyword}{sizeof}(\mbox{\hyperlink{classinternal_1_1_big_integer_a1310812fca26ebae77594ba08678fc4c}{Type}})) == 0;}
\DoxyCodeLine{161     \}}
\DoxyCodeLine{162 }
...
\DoxyCodeLine{164         \textcolor{keywordflow}{return} count\_ == 1 \&\& digits\_[0] == rhs;}
\DoxyCodeLine{165     \}}
\DoxyCodeLine{166 }
...
\DoxyCodeLine{202             \textcolor{keywordflow}{if} (i < b-\/>count\_)}
\DoxyCodeLine{203                 d -\/= b-\/>digits\_[i];}
\DoxyCodeLine{204             borrow = (d > \mbox{\hyperlink{pointer_8h_aeeddce917cf130d62c370b8f216026dd}{a}}-\/>digits\_[i]) ? 1 : 0;}
\DoxyCodeLine{205             out-\/>digits\_[i] = d;}
\DoxyCodeLine{206             \textcolor{keywordflow}{if} (d != 0)}
\DoxyCodeLine{207                 out-\/>count\_ = i + 1;}
\DoxyCodeLine{208         \}}
\DoxyCodeLine{209 }
...
\DoxyCodeLine{214         \textcolor{keywordflow}{if} (count\_ != rhs.count\_)}
\DoxyCodeLine{215             \textcolor{keywordflow}{return} count\_ < rhs.count\_ ? -\/1 : 1;}
\DoxyCodeLine{216 }
\DoxyCodeLine{217         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{size\_t} i = count\_; i-\/-\/ > 0;)}
\DoxyCodeLine{218             \textcolor{keywordflow}{if} (digits\_[i] != rhs.digits\_[i])}
\DoxyCodeLine{219                 \textcolor{keywordflow}{return} digits\_[i] < rhs.digits\_[i] ? -\/1 : 1;}
\DoxyCodeLine{220 }
\DoxyCodeLine{221         \textcolor{keywordflow}{return} 0;}
\DoxyCodeLine{222     \}}
\DoxyCodeLine{223 }
\DoxyCodeLine{224     \textcolor{keywordtype}{size\_t} \mbox{\hyperlink{classinternal_1_1_big_integer_aa0ad6e74839b7c7fe77c9742ec079525}{GetCount}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} count\_; \}}
...
\DoxyCodeLine{226     \textcolor{keywordtype}{bool} \mbox{\hyperlink{classinternal_1_1_big_integer_ae12dd6759f1f76501db3d1bcafce39cd}{IsZero}}()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} count\_ == 1 \&\& digits\_[0] == 0; \}}
\DoxyCodeLine{227 }
\DoxyCodeLine{228 \textcolor{keyword}{private}:}
\DoxyCodeLine{229     \textcolor{keyword}{template}<\textcolor{keyword}{typename} Ch>}
\DoxyCodeLine{230     \textcolor{keywordtype}{void} AppendDecimal64(\textcolor{keyword}{const} Ch* begin, \textcolor{keyword}{const} Ch* end) \{}
\DoxyCodeLine{231         \mbox{\hyperlink{stdint_8h_aec6fcb673ff035718c238c8c9d544c47}{uint64\_t}} u = ParseUint64(begin, end);}
...
\DoxyCodeLine{238     \}}
\DoxyCodeLine{239 }
\DoxyCodeLine{240     \textcolor{keywordtype}{void} PushBack(\mbox{\hyperlink{rapidjson_8h_a1d1cfd8ffb84e947f82999c682b666a7}{Type}} digit) \{}
\DoxyCodeLine{241         \mbox{\hyperlink{group___r_a_p_i_d_j_s_o_n___c_o_n_f_i_g_gabeba18d612187bad2ac62aed9276d47c}{RAPIDJSON\_ASSERT}}(count\_ < kCapacity);}
\DoxyCodeLine{242         digits\_[count\_++] = digit;}
\DoxyCodeLine{243     \}}
\DoxyCodeLine{244 }
\DoxyCodeLine{245     \textcolor{keyword}{template}<\textcolor{keyword}{typename} Ch>}
\DoxyCodeLine{246     \textcolor{keyword}{static} \mbox{\hyperlink{stdint_8h_aec6fcb673ff035718c238c8c9d544c47}{uint64\_t}} ParseUint64(\textcolor{keyword}{const} Ch* begin, \textcolor{keyword}{const} Ch* end) \{}
...
\DoxyCodeLine{256     \textcolor{keyword}{static} \mbox{\hyperlink{stdint_8h_aec6fcb673ff035718c238c8c9d544c47}{uint64\_t}} MulAdd64(\mbox{\hyperlink{stdint_8h_aec6fcb673ff035718c238c8c9d544c47}{uint64\_t}} \mbox{\hyperlink{pointer_8h_aeeddce917cf130d62c370b8f216026dd}{a}}, \mbox{\hyperlink{stdint_8h_aec6fcb673ff035718c238c8c9d544c47}{uint64\_t}} b, \mbox{\hyperlink{stdint_8h_aec6fcb673ff035718c238c8c9d544c47}{uint64\_t}} k, \mbox{\hyperlink{stdint_8h_aec6fcb673ff035718c238c8c9d544c47}{uint64\_t}}* outHigh) \{}
...
\DoxyCodeLine{284     \}}
\DoxyCodeLine{285 }
\DoxyCodeLine{286     \textcolor{keyword}{static} \textcolor{keyword}{const} \textcolor{keywordtype}{size\_t} kBitCount = 3328;  \textcolor{comment}{// 64bit * 54 > 10\string^1000}}
\DoxyCodeLine{287     \textcolor{keyword}{static} \textcolor{keyword}{const} \textcolor{keywordtype}{size\_t} kCapacity = kBitCount / \textcolor{keyword}{sizeof}(\mbox{\hyperlink{classinternal_1_1_big_integer_a1310812fca26ebae77594ba08678fc4c}{Type}});}
\DoxyCodeLine{288     \textcolor{keyword}{static} \textcolor{keyword}{const} \textcolor{keywordtype}{size\_t} kTypeBit = \textcolor{keyword}{sizeof}(\mbox{\hyperlink{classinternal_1_1_big_integer_a1310812fca26ebae77594ba08678fc4c}{Type}}) * 8;}
\DoxyCodeLine{289 }
\DoxyCodeLine{290     \mbox{\hyperlink{rapidjson_8h_a1d1cfd8ffb84e947f82999c682b666a7}{Type}} digits\_[kCapacity];}
\DoxyCodeLine{291     \textcolor{keywordtype}{size\_t} count\_;}
\DoxyCodeLine{292 \};}
\DoxyCodeLine{293 }
