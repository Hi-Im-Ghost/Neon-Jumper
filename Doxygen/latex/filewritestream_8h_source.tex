...
\DoxyCodeLine{35 }
\DoxyCodeLine{36     \mbox{\hyperlink{class_file_write_stream_a553ea3e7377a7f7cace2daa3cc90e1a1}{FileWriteStream}}(std::FILE* fp, \textcolor{keywordtype}{char}* buffer, \textcolor{keywordtype}{size\_t} bufferSize) : \mbox{\hyperlink{class_file_write_stream_aac23a58bdaa601d276c57b5bcf5b0246}{fp\_}}(fp), \mbox{\hyperlink{class_file_write_stream_a6a1f0fed15eb38f22935f11af493972f}{buffer\_}}(buffer), \mbox{\hyperlink{class_file_write_stream_a1f30d1c653f30ca6e069cefb80881c75}{bufferEnd\_}}(buffer + bufferSize), \mbox{\hyperlink{class_file_write_stream_a3b3ba8e5deef1b12f0662e9031f05c71}{current\_}}(\mbox{\hyperlink{class_file_write_stream_a6a1f0fed15eb38f22935f11af493972f}{buffer\_}}) \{ }
\DoxyCodeLine{37         \mbox{\hyperlink{group___r_a_p_i_d_j_s_o_n___c_o_n_f_i_g_gabeba18d612187bad2ac62aed9276d47c}{RAPIDJSON\_ASSERT}}(\mbox{\hyperlink{class_file_write_stream_aac23a58bdaa601d276c57b5bcf5b0246}{fp\_}} != 0);}
\DoxyCodeLine{38     \}}
\DoxyCodeLine{39 }
...
\DoxyCodeLine{41         \textcolor{keywordflow}{if} (\mbox{\hyperlink{class_file_write_stream_a3b3ba8e5deef1b12f0662e9031f05c71}{current\_}} >= \mbox{\hyperlink{class_file_write_stream_a1f30d1c653f30ca6e069cefb80881c75}{bufferEnd\_}})}
\DoxyCodeLine{42             \mbox{\hyperlink{class_file_write_stream_a939fbf183ba36464c5e0837df4329d37}{Flush}}();}
\DoxyCodeLine{43 }
\DoxyCodeLine{44         *\mbox{\hyperlink{class_file_write_stream_a3b3ba8e5deef1b12f0662e9031f05c71}{current\_}}++ = c;}
\DoxyCodeLine{45     \}}
\DoxyCodeLine{46 }
...
\DoxyCodeLine{48         \textcolor{keywordtype}{size\_t} avail = \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(\mbox{\hyperlink{class_file_write_stream_a1f30d1c653f30ca6e069cefb80881c75}{bufferEnd\_}} -\/ \mbox{\hyperlink{class_file_write_stream_a3b3ba8e5deef1b12f0662e9031f05c71}{current\_}});}
\DoxyCodeLine{49         \textcolor{keywordflow}{while} (n > avail) \{}
\DoxyCodeLine{50             std::memset(\mbox{\hyperlink{class_file_write_stream_a3b3ba8e5deef1b12f0662e9031f05c71}{current\_}}, c, avail);}
\DoxyCodeLine{51             \mbox{\hyperlink{class_file_write_stream_a3b3ba8e5deef1b12f0662e9031f05c71}{current\_}} += avail;}
\DoxyCodeLine{52             \mbox{\hyperlink{class_file_write_stream_a939fbf183ba36464c5e0837df4329d37}{Flush}}();}
\DoxyCodeLine{53             n -\/= avail;}
\DoxyCodeLine{54             avail = \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(\mbox{\hyperlink{class_file_write_stream_a1f30d1c653f30ca6e069cefb80881c75}{bufferEnd\_}} -\/ \mbox{\hyperlink{class_file_write_stream_a3b3ba8e5deef1b12f0662e9031f05c71}{current\_}});}
\DoxyCodeLine{55         \}}
\DoxyCodeLine{56 }
\DoxyCodeLine{57         \textcolor{keywordflow}{if} (n > 0) \{}
\DoxyCodeLine{58             std::memset(\mbox{\hyperlink{class_file_write_stream_a3b3ba8e5deef1b12f0662e9031f05c71}{current\_}}, c, n);}
\DoxyCodeLine{59             \mbox{\hyperlink{class_file_write_stream_a3b3ba8e5deef1b12f0662e9031f05c71}{current\_}} += n;}
\DoxyCodeLine{60         \}}
\DoxyCodeLine{61     \}}
\DoxyCodeLine{62 }
\DoxyCodeLine{63     \textcolor{keywordtype}{void} \mbox{\hyperlink{class_file_write_stream_a939fbf183ba36464c5e0837df4329d37}{Flush}}() \{}
\DoxyCodeLine{64         \textcolor{keywordflow}{if} (\mbox{\hyperlink{class_file_write_stream_a3b3ba8e5deef1b12f0662e9031f05c71}{current\_}} != \mbox{\hyperlink{class_file_write_stream_a6a1f0fed15eb38f22935f11af493972f}{buffer\_}}) \{}
\DoxyCodeLine{65             \textcolor{keywordtype}{size\_t} result = std::fwrite(\mbox{\hyperlink{class_file_write_stream_a6a1f0fed15eb38f22935f11af493972f}{buffer\_}}, 1, \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(\mbox{\hyperlink{class_file_write_stream_a3b3ba8e5deef1b12f0662e9031f05c71}{current\_}} -\/ \mbox{\hyperlink{class_file_write_stream_a6a1f0fed15eb38f22935f11af493972f}{buffer\_}}), \mbox{\hyperlink{class_file_write_stream_aac23a58bdaa601d276c57b5bcf5b0246}{fp\_}});}
\DoxyCodeLine{66             \textcolor{keywordflow}{if} (result < \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(\mbox{\hyperlink{class_file_write_stream_a3b3ba8e5deef1b12f0662e9031f05c71}{current\_}} -\/ \mbox{\hyperlink{class_file_write_stream_a6a1f0fed15eb38f22935f11af493972f}{buffer\_}})) \{}
...
\DoxyCodeLine{69             \}}
\DoxyCodeLine{70             \mbox{\hyperlink{class_file_write_stream_a3b3ba8e5deef1b12f0662e9031f05c71}{current\_}} = \mbox{\hyperlink{class_file_write_stream_a6a1f0fed15eb38f22935f11af493972f}{buffer\_}};}
\DoxyCodeLine{71         \}}
\DoxyCodeLine{72     \}}
\DoxyCodeLine{73 }
...
\DoxyCodeLine{83     \mbox{\hyperlink{class_file_write_stream_a62cc69f885b946b6bc2935f40c970cbb}{FileWriteStream}}(\textcolor{keyword}{const} \mbox{\hyperlink{class_file_write_stream}{FileWriteStream}}\&);}
\DoxyCodeLine{84     \mbox{\hyperlink{class_file_write_stream}{FileWriteStream}}\& \mbox{\hyperlink{class_file_write_stream_a41ed06dc63f576bbab6dd323c6f4056c}{operator=}}(\textcolor{keyword}{const} \mbox{\hyperlink{class_file_write_stream}{FileWriteStream}}\&);}
\DoxyCodeLine{85 }
\DoxyCodeLine{86     std::FILE* \mbox{\hyperlink{class_file_write_stream_aac23a58bdaa601d276c57b5bcf5b0246}{fp\_}};}
\DoxyCodeLine{87     \textcolor{keywordtype}{char} *\mbox{\hyperlink{class_file_write_stream_a6a1f0fed15eb38f22935f11af493972f}{buffer\_}};}
\DoxyCodeLine{88     \textcolor{keywordtype}{char} *\mbox{\hyperlink{class_file_write_stream_a1f30d1c653f30ca6e069cefb80881c75}{bufferEnd\_}};}
\DoxyCodeLine{89     \textcolor{keywordtype}{char} *\mbox{\hyperlink{class_file_write_stream_a3b3ba8e5deef1b12f0662e9031f05c71}{current\_}};}
\DoxyCodeLine{90 \};}
\DoxyCodeLine{91 }
